...
public class Main extends JFrame implements MouseListener
{
	...
	private Main()
    {
		...
		setTitle("Ajedrez LCRR");
		content.setBackground(Color.black);
		controlPanel=new JPanel();
		content.setLayout(new BorderLayout());
		controlPanel.setLayout(new GridLayout(3,3));
		controlPanel.setBorder(BorderFactory.createTitledBorder(null, "Estadisticas", TitledBorder.TOP,TitledBorder.CENTER, new Font("Lucida Calligraphy",Font.PLAIN,20), Color.BLACK));
		

		WhitePlayer=new JPanel();
		WhitePlayer.setBorder(BorderFactory.createTitledBorder(null, "Jugador Fichas Blancas", TitledBorder.TOP,TitledBorder.CENTER, new Font("times new roman",Font.BOLD,18), Color.BLACK));
		WhitePlayer.setLayout(new BorderLayout());
		
		BlackPlayer=new JPanel();
		BlackPlayer.setBorder(BorderFactory.createTitledBorder(null, "Jugador Fichas Negras", TitledBorder.TOP,TitledBorder.CENTER, new Font("times new roman",Font.BOLD,18), Color.BLACK));
		...
		wselect=new Button("Seleccionar");
		bselect=new Button("Seleccionar");
		wselect.addActionListener(new SelectHandler(0));
		bselect.addActionListener(new SelectHandler(1));
		WNewPlayer=new Button("Nuevo Jugador");
		BNewPlayer=new Button("Nuevo Jugador");
		...
		whitestats.add(new JLabel("Nombre   :"));
		whitestats.add(new JLabel("Partidas Jugadas :"));
		whitestats.add(new JLabel("Partidas Ganadas    :"));
		blackstats.add(new JLabel("Nombre   :"));
		blackstats.add(new JLabel("Partidas Jugadas :"));
		blackstats.add(new JLabel("Partidas Ganadas    :"));
		...
		JLabel setTime=new JLabel("Configurar Tiempo (minutos):"); 
    ...
    private boolean willkingbeindanger(Cell fromcell,Cell tocell)
    {
    	...
    	for(int i=0;i<8;i++)
    		for(int j=0;j<8;j++)
    		{	try { newboardstate[i][j] = new Cell(boardState[i][j]);} catch (CloneNotSupportedException e){e.printStackTrace(); System.out.println("Hay problemas con la clonacion"); }}
	...
	private void gameend()
    {
		...
		JOptionPane.showMessageDialog(board,"¡JaqueMate!\n"+winner+" Ha ganado...");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(White==null||Black==null)
			{JOptionPane.showMessageDialog(controlPanel, "Completa los detalles.");
			return;}
	...
	class SelectHandler implements ActionListener
	{
		...
		class Handler implements ActionListener{
			...
			public void actionPerformed(ActionEvent e) {
				...
				JPanel det=(color==0)?wdetails:bdetails;
				n=JOptionPane.showInputDialog(j,"Ingresa tu nombre");
					...
					while(it.hasNext())
					{
						...
						{JOptionPane.showMessageDialog(j,"Jugador ya registrado");
						return;}
					}
